function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./saddle-animation-text-animation-example-layered-effects_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('saddle-animation-text-animation-example-layered-effects_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
